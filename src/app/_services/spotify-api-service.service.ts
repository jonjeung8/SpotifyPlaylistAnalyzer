...
export class SpotifyApiServiceService {
  ...
  GetPlaylistResults(playlist_id:string, bearerToken: string)
  {
    ...
    let url = "https://api.spotify.com/v1/playlists/" + playlist_id + "/tracks?market=ES&fields=items(added_by.id%2Ctrack(name%2Chref%2Calbum(name%2Chref)%2Cid))&limit=100&offset=0";
